"""
src/agent/sales_agent.py — Agente de vendas MedReview.
...
# Paths relativos à raiz do projeto (2 níveis acima de src/agent/)
BASE_DIR = os.path.dirname(os.path.dirname(os.path.dirname(__file__)))
PROMPT_PATH         = os.path.join(BASE_DIR, "src/agent/prompts/system_prompt.md")
STAGE_SCRIPTS_PATH  = os.path.join(BASE_DIR, "src/agent/prompts/stage_scripts.md")

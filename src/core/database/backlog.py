...
def get_next_item_id() -> str:
    """Gera próximo ID sequencial (CRI-XXX)."""
    items = load_backlog()
    max_num = 0
    for item in items:
        iid = item.get("item_id", "")
        if iid.startswith("CRI-"):
            try:
                num = int(iid.replace("CRI-", ""))
                if num > max_num:
                    max_num = num
            except ValueError:
                pass
    return f"CRI-{max_num + 1:03d}"
...
def _get_seed_data() -> list:
    ...
    seed = [
        {
            "item_id": "CRI-001", "title": "Follow-up Scheduler",
            ...
            "item_type": "feature", "module": "core", "status": "backlog", "phase": "Phase 2",
        ...
        {
            "item_id": "CRI-002", "title": "Webhook Hotmart (Pagamento)",
            ...
            "item_type": "feature", "module": "integrations", "status": "backlog", "phase": "Phase 2",
        ...
        {
            "item_id": "CRI-003", "title": "Persistir Estágio do Funil",
            ...
            "item_type": "enhancement", "module": "database", "status": "backlog", "phase": "Phase 2",
        ...
        },
        {
            ...
            "item_type": "feature", "module": "dashboard", "status": "backlog", "phase": "Phase 2",
            "reach": 100, "impact": 2.0, "confidence": 0.8, "effort": 3.0,
            "estimate": "1w", "dependencies": "CRI-003", "notes": "Depende de CRI-003 para dados confiáveis", "sort_order": 4,
        },
        {
            "item_id": "CRI-006", "title": "HubSpot Events Completos",
            "description": "Enviar eventos para HubSpot em todas as transições de estágio. Timeline completa no CRM.",
            "item_type": "enhancement", "module": "integrations", "status": "backlog", "phase": "Phase 2",
            "reach": 50, "impact": 1.0, "confidence": 0.8, "effort": 2.0,
            "estimate": "2d", "dependencies": "", "notes": "", "sort_order": 5,
        },
        {
            "item_id": "CRI-007", "title": "Monitorar Memory Leak (Cache TTL)",
            ...
            "item_type": "bugfix", "module": "core", "status": "next", "phase": "Phase 2",
        ...
        {
            "item_id": "CRI-009", "title": "A/B Testing de Prompts",
            "description": "Framework para testar variações de prompt. Distribuir leads entre variantes, medir conversão por variante.",
            "item_type": "feature", "module": "agent", "status": "backlog", "phase": "Phase 3",
            "reach": 500, "impact": 2.0, "confidence": 0.5, "effort": 5.0,
            "estimate": "2w", "dependencies": "CRI-003", "notes": "Precisa de infraestrutura de experimentação", "sort_order": 8,
        },
        {
            "item_id": "CRI-010", "title": "Seleção Dinâmica de Oferta",
        ...
        {
            "item_id": "CRI-011", "title": "Desconto Dinâmico (até 10%)",
        ...
        {
            "item_id": "CRI-012", "title": "Integração Botmaker (Transfer Direto)",
            "description": "Transferir conversa para atendente humano via Botmaker API quando escalar. Já tem config vars preparadas.",
            "item_type": "feature", "module": "integrations", "status": "backlog", "phase": "Phase 3",
        ...
        {
            "item_id": "CRI-015", "title": "Multi-tenant (Outros Produtos)",
            "description": "Abstrair Criatons para suportar múltiplos produtos/clientes além da MedReview. Tenant isolation.",
            "item_type": "feature", "module": "core", "status": "backlog", "phase": "Phase 4",
            "reach": 50, "impact": 3.0, "confidence": 0.5, "effort": 13.0,
            "estimate": "6w", "dependencies": "", "notes": "Visão de longo prazo", "sort_order": 14,
        },
        {
            "item_id": "CRI-016", "title": "Voice Messages (Áudio WhatsApp)",
            "description": "Receber e transcrever áudios de WhatsApp (Whisper API). Responder considerando contexto do áudio.",
            "item_type": "feature", "module": "integrations", "status": "backlog", "phase": "Phase 4",
            "reach": 200, "impact": 2.0, "confidence": 0.5, "effort": 8.0,
            "estimate": "3w", "dependencies": "", "notes": "Whisper API para transcrição", "sort_order": 15,
        },
        {
            "item_id": "CRI-017", "title": "Agente Autônomo de Desenvolvimento",
